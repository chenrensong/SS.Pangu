...
namespace SS.Pangu
{
    ...
    public class WordInfo : WordAttribute, IComparable<WordInfo>
    {
        ...
        public WordInfo(string word, int position, POS pos, double frequency, int rank, WordType wordTye, WordType originalWordType, string originalWord = null)
